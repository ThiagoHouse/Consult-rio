  ...
  <div>
    <b-carousel id="carousel-1" v-model="slide" :interval="4000" controls indicators background="#ababab"
      ...
      <b-carousel-slide 
        ...
        text="Cuidando da sua saúde com excelência e dedicação">
        <img slot="img" class="d-block img-fluid w-100" width="1024" height="480" src="../assets/bebe.jpeg" alt="image slot">
      </b-carousel-slide>
